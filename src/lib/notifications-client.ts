...
> {
  ...
  // Chrome is free to evict this origin's storage, and eviction takes the service worker
  // registration and its subscription with it. Asking costs nothing and is the one discard path
  // a page can ask not to happen; Chrome decides silently and an installed app is usually
  // granted it.
